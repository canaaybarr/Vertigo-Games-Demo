...
namespace Handler
{
    public class WheelHandler : MonoBehaviour
    {
        ...
        {
            // Tekerleğe koymak için rastgele seçmek için tüm içeriği alın
            wheelContents.Clear();
            ...
            // WheelType = Bronze, Silver veya Gold'a göre 8 ödül seçin. Ortak sınıf ödüllerine bomba eklemeyi unutmayın
            if (wheelType == "Bronze")
            {
